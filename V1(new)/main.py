                    ...
                    try:
                        ...
                        if e > 0:
                            try:
                                ...
                                error = "Ошибка: функция была введена не правильно или промежуток слишком велик"
                        else:
                            error = "Ошибка: погрешность должна быть положительной"
                    except :
                        error = "Ошибка: погрешность должна быть цифрой"
                else:
                    error = "Ошибка: Правая граница должна быть больше левой"                    
            except:
                error = "Ошибка: правая граница должна быть числом"
        except :
            error = "Ошибка: левая граница должна быть числом"
